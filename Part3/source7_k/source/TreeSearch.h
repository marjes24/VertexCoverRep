...
void degree_two_optimization(std::list<std::list<int> > &Graph, std::list<std::list<int> >::iterator current_largest, std::vector<int> &tmp_min_cover);

void clean_degree_zero(std::list<std::list<int> > &Graph);
